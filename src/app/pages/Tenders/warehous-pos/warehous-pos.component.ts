...
@Component({
  selector: 'app-warehous-pos',
  templateUrl: './warehous-pos.component.html',
  styleUrls: ['./warehous-pos.component.css']
})
export class WarehousPosComponent implements OnInit {
