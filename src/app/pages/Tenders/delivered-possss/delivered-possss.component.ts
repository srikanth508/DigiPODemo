...
@Component({
  selector: 'app-delivered-possss',
  templateUrl: './delivered-possss.component.html',
  styleUrls: ['./delivered-possss.component.css']
})
export class DeliveredPossssComponent implements OnInit {
