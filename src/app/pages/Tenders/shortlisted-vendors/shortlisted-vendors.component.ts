...
@Component({
  selector: 'app-shortlisted-vendors',
  templateUrl: './shortlisted-vendors.component.html',
  styleUrls: ['./shortlisted-vendors.component.css']
})
export class ShortlistedVendorsComponent implements OnInit {
  ...
  public GetSupplierOrders() {
    ...
    this.pomservice.GetTendersByVendorID(this.supplierid, this.startdate, this.enddate).subscribe(data => {
      this.dummlist = data;
      this.orderslist = this.dummlist.filter(x => x.approveReject == 1)
