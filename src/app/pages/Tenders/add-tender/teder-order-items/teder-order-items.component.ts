...
@Component({
  selector: 'app-teder-order-items',
  templateUrl: './teder-order-items.component.html',
  styleUrls: ['./teder-order-items.component.css']
})
export class TederOrderItemsComponent implements OnInit {
  ...
  public GetCategoryName(even) {
    ...
    if (this.categoryname == 0) {
      ...
      this.pomservice.GetTenderOrderDetailsID(this.itemid).subscribe(data => {
        this.itemslist = data;
