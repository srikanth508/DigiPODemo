...
@Component({
  selector: 'app-submitted-tenders',
  templateUrl: './submitted-tenders.component.html',
  styleUrls: ['./submitted-tenders.component.css']
})
export class SubmittedTendersComponent implements OnInit {
  ...
  public GetSupplierOrders() {
    ...
    this.pomservice.GetTendersByVendorID(this.supplierid, this.startdate, this.enddate).subscribe(data => {
      this.dummlist = data;
      this.orderslist = this.dummlist.filter(x => x.acceptCancel == 3)
