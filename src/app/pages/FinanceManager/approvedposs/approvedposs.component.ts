...
@Component({
  selector: 'app-approvedposs',
  templateUrl: './approvedposs.component.html',
  styleUrls: ['./approvedposs.component.css']
})
export class ApprovedpossComponent implements OnInit {
