...
@Component({
  selector: 'app-newrequestioner',
  templateUrl: './newrequestioner.component.html',
  styleUrls: ['./newrequestioner.component.css']
})
export class NewrequestionerComponent implements OnInit {
