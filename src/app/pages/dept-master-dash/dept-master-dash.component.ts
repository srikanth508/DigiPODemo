...
@Component({
  selector: 'app-dept-master-dash',
  templateUrl: './dept-master-dash.component.html',
  styleUrls: ['./dept-master-dash.component.css']
})
export class DeptMasterDashComponent implements OnInit {
  ...
  public DeleteDepartmentMaster(id) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.PomsService.DeleteDepartmentMaster(id).subscribe(res => {
          let test = res;
          this.getdepartmentmaster();
        })
        Swal.fire(
