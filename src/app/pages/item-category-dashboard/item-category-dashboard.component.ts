...
export class ItemCategoryDashboardComponent implements OnInit {
  ...
  public GetCategoryMaster() {
    this.PomsService.GetCategoryMaster().subscribe(data => {
      ...
      this.count = this.CategoryItem.length;
    });
  }

  // public Delete(ID) {
    
  //   this.PomsService.DeleteCategoryMaster(ID).subscribe(res => {
  ...
  public getglmasterexcel() {
    ...
    this.exportAsExcelFile(hhh, "Category Master");
  }
  ...
  public Disablecategoryy(id) {
    ...
    Swal.fire({
      title: "Are you sure?",
      text: "You Want Disable This Category",
      icon: "warning",
      ...
      if (result.value) {
        this.PomsService.DisableCategoryMaster(id).subscribe(res => {
          let test = res;
          this.GetCategoryMaster();
        });
        Swal.fire("Deleted!", "Category has been Disabled.", "success");
  ...
  public EnableCategory(id) {
    ...
    Swal.fire({
      title: "Are you sure?",
      text: "You Want Enable This Category!",
      icon: "warning",
      showCancelButton: true,
      ...
      if (result.value) {
        this.PomsService.EnableCategoryMaster(id).subscribe(res => {
          let test = res;
          this.GetCategoryMaster();
        });
        Swal.fire("Enabled!", "Category Has been Enabled", "success");
      } else if (result.dismiss === Swal.DismissReason.cancel) {
        Swal.fire("Cancelled", "Your Data  is safe :)", "error");
        this.GetCategoryMaster();
      }
